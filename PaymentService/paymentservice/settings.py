...
SECRET_KEY = 'django-insecure-v&&@rtj_4yl6e5l3e9ep9zf7@5(ws%!3^l0m-utzt@21*h$#n0'
...
# Database – connect to your Postgres "paymentservice" DB
DATABASES = {
    'default': {
...
# REST framework config (optional for cleaner JSON APIs)
REST_FRAMEWORK = {
